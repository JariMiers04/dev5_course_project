...
function checkPutFood(food){
    if(!food || !food.product_name || !food.expiration_date || !food.weight || !food.fridge_id){
        return false
    }if(!checkExpirationDate(food.expiration_date) || !checkFoodProductName(food.product_name) || !checkFoodWeight(food.weight)){
        return false
    }else{
        return true
    }
...
module.exports = {checkPostFood,checkPutFood, checkExpirationDate, checkFoodWeight, checkFoodProductName,checkFoodBarcode}